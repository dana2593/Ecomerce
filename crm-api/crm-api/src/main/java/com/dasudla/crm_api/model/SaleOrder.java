...
public class SaleOrder {
    ...
    public SaleOrder(Long id, String refNumber, Float total, Calendar registDate, OrderStatus status,
                     Customer customer, Set<OrderLine> orderLines, Set<Payment> payments) {
        this.id = id;
